...
TerraWatch is configured to be fully stateless and is ready for deployment on platforms like Vercel (Frontend) and Render/Railway (Backend).
...
pip install fastapi uvicorn pystac-client planetary-computer odc-stac xarray matplotlib pillow diskcache scipy
